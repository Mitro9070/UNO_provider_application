...
class SettingsController extends GetxController {
  ...
  final pages = <String>[Routes.PROFILE, Routes.SETTINGS_DOCUMENTS, Routes.SETTINGS_LANGUAGE, Routes.SETTINGS_THEME_MODE];
  ...
  Route? onGenerateRoute(RouteSettings settings) {
    ...
    if (settings.name == Routes.SETTINGS_DOCUMENTS)
      return GetPageRoute(
        settings: settings,
        page: () => DocumentsView(hideAppBar: true),
